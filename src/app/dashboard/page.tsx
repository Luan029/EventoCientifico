...
export function HomeScreen() {
    ...
    return (
        <main className={styles.eventDescription}>
            <section className={`${styles.description} ${hour >= 6 && hour < 18 ? styles.day : styles.night }`}>
            ...
            <section className={styles.register} >
                <Button text='Realizar Inscrição' color={hour >=6 && hour < 18 ? "#F2921D" : "#020659"} link='/registrations' type='button'/>

                <Button text='Submeter Artigo' color={hour >=6 && hour < 18 ? "#F2921D" : "#020659"} link='/article' type='button'/>
            </section>
        </main>
    )
}
